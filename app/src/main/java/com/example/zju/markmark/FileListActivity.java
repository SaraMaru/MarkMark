...
public class FileListActivity extends AppCompatActivity {
    ...
    public static final String txtDefaultFolder = "/storage/emulated/0/MarkMark/txt";
    public static final String jsonDefaultFolder = "/storage/emulated/0/MarkMark/json";
